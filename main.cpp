...
//----------------------------------------------------------------
template <class T>
void partition(T data[], int low, int high, int & mid, const int pivotIndex)
{
    // Select pivot value
...
template <class T>
void partition3Way(T data[], int low, int high, int &l, int &r, const int pivotIndex)
{
    ...
    if (low < high)
    {
        ...
        else
        {
            ...
            if ((choice == 1) || (choice == 4))
            {
                ...
                partition(data, low, high, mid, high);
            ...
            else if ( (choice == 2) || (choice == 6))
            {
                int l, r;
                // use last element as pivot in partition
                partition3Way(data, low, high, l, r,high);
            ...
            else if ((choice == 3) ||(choice == 7))
            {
                ...
                partition(data, low, high, mid, (high+low)/2);
            ...
            else if ((choice == 5) || (choice == 8))
            {
                int l, r;
                // use middle element as pivot in partition
                partition3Way(data, low, high, l, r, (high + low)/2);
